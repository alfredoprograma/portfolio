				...
				roles: [
					{
						...
						highlights: [
							...
							"Built the document scraper as a worker pool of goroutines fed over channels, fetching and parsing a batch concurrently rather than one document at a time, with the size of the pool bounding how many requests stayed in flight against a source at once.",
